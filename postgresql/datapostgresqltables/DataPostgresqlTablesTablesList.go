...
func (j *jsiiProxy_DataPostgresqlTablesTablesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataPostgresqlTablesTablesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataPostgresqlTablesTablesList {
	_init_.Initialize()
...
func NewDataPostgresqlTablesTablesList_Override(d DataPostgresqlTablesTablesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataPostgresqlTablesTablesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataPostgresqlTablesTablesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataPostgresqlTablesTablesList) Resolve(context cdktn.IResolveContext) interface{} {
