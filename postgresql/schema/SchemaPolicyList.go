...
func (j *jsiiProxy_SchemaPolicyList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSchemaPolicyList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) SchemaPolicyList {
	_init_.Initialize()
...
func NewSchemaPolicyList_Override(s SchemaPolicyList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SchemaPolicyList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SchemaPolicyList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (s *jsiiProxy_SchemaPolicyList) Resolve(context cdktn.IResolveContext) interface{} {
