...
import (
	...
	"github.com/cdktn-io/cdktn-provider-postgresql-go/postgresql/v13/schema/internal"
...
func (j *jsiiProxy_SchemaPolicyOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSchemaPolicyOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) SchemaPolicyOutputReference {
	_init_.Initialize()
...
func NewSchemaPolicyOutputReference_Override(s SchemaPolicyOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SchemaPolicyOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SchemaPolicyOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SchemaPolicyOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_SchemaPolicyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SchemaPolicyOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
