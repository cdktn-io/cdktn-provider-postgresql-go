...
import (
	...
	"github.com/cdktn-io/cdktn-provider-postgresql-go/postgresql/v15/publication/internal"
...
func (p *jsiiProxy_Publication) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (p *jsiiProxy_Publication) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (p *jsiiProxy_Publication) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
