...
import (
	...
	"github.com/cdktn-io/cdktn-provider-postgresql-go/postgresql/v15/server/internal"
...
func (j *jsiiProxy_Server) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Server) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Server) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Server) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Server) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_Server)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Server)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Server)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func Server_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_Server) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_Server) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_Server) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_Server) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_Server) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_Server) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
