// Deprecated: HashiCorp is no longer publishing new versions of the prebuilt provider for postgresql.
...
// You can continue to use the postgresql provider in your CDK for Terraform projects with newer versions of CDKTF,
