...
import (
	...
	"github.com/cdktn-io/cdktn-provider-postgresql-go/postgresql/v15/extension/internal"
...
func NewExtension(scope constructs.Construct, id *string, config *ExtensionConfig) Extension {
	...
	_jsii_.Create(
		"@cdktn/provider-postgresql.extension.Extension",
...
func (e *jsiiProxy_Extension) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (e *jsiiProxy_Extension) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
