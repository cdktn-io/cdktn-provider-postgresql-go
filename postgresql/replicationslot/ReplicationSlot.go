...
import (
	...
	"github.com/cdktn-io/cdktn-provider-postgresql-go/postgresql/v15/replicationslot/internal"
...
func (j *jsiiProxy_ReplicationSlot) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ReplicationSlot) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ReplicationSlot) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ReplicationSlot) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ReplicationSlot) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func NewReplicationSlot(scope constructs.Construct, id *string, config *ReplicationSlotConfig) ReplicationSlot {
	...
	_jsii_.Create(
		"@cdktn/provider-postgresql.replicationSlot.ReplicationSlot",
...
func (j *jsiiProxy_ReplicationSlot)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ReplicationSlot)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ReplicationSlot)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ReplicationSlot_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (r *jsiiProxy_ReplicationSlot) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_ReplicationSlot) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (r *jsiiProxy_ReplicationSlot) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_ReplicationSlot) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (r *jsiiProxy_ReplicationSlot) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (r *jsiiProxy_ReplicationSlot) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
