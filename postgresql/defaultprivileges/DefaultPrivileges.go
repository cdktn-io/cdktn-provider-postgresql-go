...
import (
	...
	"github.com/cdktn-io/cdktn-provider-postgresql-go/postgresql/v15/defaultprivileges/internal"
...
func (j *jsiiProxy_DefaultPrivileges) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DefaultPrivileges) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DefaultPrivileges) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DefaultPrivileges) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DefaultPrivileges) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func NewDefaultPrivileges(scope constructs.Construct, id *string, config *DefaultPrivilegesConfig) DefaultPrivileges {
	...
	_jsii_.Create(
		"@cdktn/provider-postgresql.defaultPrivileges.DefaultPrivileges",
...
func (j *jsiiProxy_DefaultPrivileges)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DefaultPrivileges)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DefaultPrivileges)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DefaultPrivileges_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DefaultPrivileges) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DefaultPrivileges) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DefaultPrivileges) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DefaultPrivileges) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DefaultPrivileges) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DefaultPrivileges) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
