...
import (
	...
	"github.com/cdktn-io/cdktn-provider-postgresql-go/postgresql/v15/datapostgresqlschemas/internal"
...
func (j *jsiiProxy_DataPostgresqlSchemas) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataPostgresqlSchemas) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataPostgresqlSchemas) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataPostgresqlSchemas) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataPostgresqlSchemas) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func NewDataPostgresqlSchemas(scope constructs.Construct, id *string, config *DataPostgresqlSchemasConfig) DataPostgresqlSchemas {
	...
	_jsii_.Create(
		"@cdktn/provider-postgresql.dataPostgresqlSchemas.DataPostgresqlSchemas",
...
func (j *jsiiProxy_DataPostgresqlSchemas)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataPostgresqlSchemas)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataPostgresqlSchemas)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataPostgresqlSchemas_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataPostgresqlSchemas) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataPostgresqlSchemas) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataPostgresqlSchemas) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataPostgresqlSchemas) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
