...
import (
	...
	"github.com/cdktn-io/cdktn-provider-postgresql-go/postgresql/v15/physicalreplicationslot/internal"
...
func (p *jsiiProxy_PhysicalReplicationSlot) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (p *jsiiProxy_PhysicalReplicationSlot) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (p *jsiiProxy_PhysicalReplicationSlot) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
