...
import (
	...
	"github.com/cdktn-io/cdktn-provider-postgresql-go/postgresql/v15/functionresource/internal"
...
func (j *jsiiProxy_FunctionResource) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_FunctionResource) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_FunctionResource) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_FunctionResource) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_FunctionResource) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_FunctionResource)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_FunctionResource)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_FunctionResource)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func FunctionResource_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (f *jsiiProxy_FunctionResource) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FunctionResource) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (f *jsiiProxy_FunctionResource) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FunctionResource) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (f *jsiiProxy_FunctionResource) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (f *jsiiProxy_FunctionResource) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
