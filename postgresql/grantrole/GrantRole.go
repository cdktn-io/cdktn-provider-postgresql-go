...
import (
	...
	"github.com/cdktn-io/cdktn-provider-postgresql-go/postgresql/v15/grantrole/internal"
...
func (j *jsiiProxy_GrantRole) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GrantRole) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GrantRole) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GrantRole) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_GrantRole) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func NewGrantRole(scope constructs.Construct, id *string, config *GrantRoleConfig) GrantRole {
	...
	_jsii_.Create(
		"@cdktn/provider-postgresql.grantRole.GrantRole",
...
func (j *jsiiProxy_GrantRole)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GrantRole)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GrantRole)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func GrantRole_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GrantRole) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GrantRole) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GrantRole) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GrantRole) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GrantRole) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GrantRole) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
